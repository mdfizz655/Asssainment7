...
import { NavLink } from 'react-router-dom';
  ...
  return (
    <nav className="flex justify-between items-center px-16 py-4 bg-white sticky top-0 z-50">


         <div className="font-bold text-xl text-gray-800 tracking-tight">KeenKeeper</div>
