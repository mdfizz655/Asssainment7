...
const Footer = () => {
    ...
    return (
           ...
           <footer className="bg-primary text-white py-16">
                ...
                <p className="text-gray-300 text-sm mb-8 leading-relaxed max-w-2xl mx-auto">
            ...
            <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-4">Social Links</p>


           <div className="flex justify-center gap-4 mb-12">


              <a href="#" className="bg-white text-primary p-2 rounded-full hover:scale-110 transition-transform">
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-400 font-medium">
